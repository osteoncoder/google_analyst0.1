...
| Phase 4 — `VIVA_PREP.txt` | ✅ **DONE** (2026-09-20) — 381-line plain-text file; every number re-read from the measured artifacts (caught the README's 180-per-model parity error → 60/model, 180 total); downloadable from §09 via a `.text-link` that works in all four serving modes | `d012445` |
